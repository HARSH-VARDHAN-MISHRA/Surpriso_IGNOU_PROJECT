            ...
            <div className="d-form">
                <form className="row g-3" onSubmit={postData}>
                    <div className="col-md-4">
                        ...
                        <select name='categoryName' onChange={getInputData} className="form-select" id="categoryName">
                    ...
                    {imageFields.map((field, index) => (
                        <div key={index} className="col-md-3">
                            ...
                            <input type="file" name={field} onChange={getFileData} className='form-control' id={field}  required/>
                            {index >= 0 && (
