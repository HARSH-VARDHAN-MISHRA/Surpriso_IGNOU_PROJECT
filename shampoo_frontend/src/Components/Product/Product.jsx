                    ...
                    <div className="container-fluid py-5">
                        <div className="container">
                            <div className="mx-auto text-center wow fadeIn" data-wow-delay="0.1s">
                                <h1 className="text-primary mb-3"><span className="fw-light text-dark">Discover the Perfect</span> Gift for Every Occasion</h1>
                                <p className="mb-5">
                                    At <strong>Surprizo</strong>, we bring you thoughtfully curated gifts that create lasting memories.
                                    Whether it's a birthday, anniversary, or a surprise just because—find something special for your loved ones.
                                </p>
                            </div>
