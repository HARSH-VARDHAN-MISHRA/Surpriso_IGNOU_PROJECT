                        ...
                        <div className="col-lg-4 wow fadeIn" data-wow-delay="0.1s">
                            <div className="contact-info-item position-relative bg-primary text-center p-3">
                                <div className="border py-5 px-3">
                                    ...
                                    <h5 className="fw-light text-white">A-123 Delhi</h5>
                                </div>
                            </div>
                        </div>
                        <div className="col-lg-4 wow fadeIn" data-wow-delay="0.3s">
                            <div className="contact-info-item position-relative bg-primary text-center p-3">
                                <div className="border py-5 px-3">
                                    ...
                                    <h5 className="fw-light text-white">+91-9876543210</h5>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="row g-5">
                        <div className="col-lg-7 wow fadeIn" data-wow-delay="0.1s">
                            <p className="mb-4">
                                ...
                                Our team is here to make your gifting experience seamless and special.
                            </p>
