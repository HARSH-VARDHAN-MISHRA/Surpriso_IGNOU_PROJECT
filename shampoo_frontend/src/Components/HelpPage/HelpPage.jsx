        ...
        <div className="help-page">
            ...
            <main className="help-content">
                ...
                <section className="contact">
                    <h5>Contact Us</h5>
                    <p>If you have any other questions, feel free to contact us at <Link to="mailto:support@Surpriso.com">support@Surpriso.com</Link>.</p>
                </section>
            </main>
            <footer className="help-footer">
                <p>&copy; 2024 Surpriso. All rights reserved.</p>
            </footer>
        </div>
    );
};
